...
for (var  a=0; a<38;  a++){
  ...
  var circle1 = L.circle( latlng1, {
    ...
    "</h3><hr><p>2019 Number of Delay Happened: " + data[a].num_delays_2019 + 
    " </p><hr><p> 2019 Avg Delay Time: " + data[a].avg_delay_time_2019 + " minutes </p>"+ 
    "</h3><hr><p>2018 Number of Delay Happened: " + data[a].num_delays_2018 +
    " </p><hr><p> 2018 Avg Delay Time: " + data[a].avg_delay_time_2018 + " minutes </p>").addTo(line1layer);
...
for (var i=38; i <69; i++) {
  ...
  var circle2 = L.circle( latlng2, {
      ...
      fillOpacity: 0.7,
      radius: 60
    }).bindPopup("<h3>" + data[i].station + "</h3><hr><p>2019 Number of Delay Happened: " + data[i].num_delays_2019 + 
    " </p><hr><p> 2019 Avg Delay Time: " + data[i].avg_delay_time_2019 + " minutes </p>"+ 
    "</h3><hr><p>2018 Number of Delay Happened: " + data[i].num_delays_2018 +
    " </p><hr><p> 2018 Avg Delay Time: " + data[i].avg_delay_time_2018 + " minutes </p>").addTo(line2layer); 
...
for (var j =69; j <75; j ++){
  ...
  var circle3 = L.circle(latlng3, {
    ...
    "</h3><hr><p>2019 Number of Delay Happened: " + data[j].num_delays_2019 + 
    " </p><hr><p> 2019 Avg Delay Time: " + data[j].avg_delay_time_2019 + " minutes </p>"+ 
    "</h3><hr><p>2018 Number of Delay Happened: " + data[j].num_delays_2018 +
    " </p><hr><p> 2018 Avg Delay Time: " + data[j].avg_delay_time_2018 + " minutes </p>").addTo(line3layer);
...
for (var k =75; k<80;  k++){
  ...
  var circle4 = L.circle( [parseFloat(data[k].latitude), parseFloat(data[k].longitude)], {
    ...
    "</h3><hr><p>2019 Number of Delay Happened: " + data[k].num_delays_2019 + 
    " </p><hr><p> 2019 Avg Delay Time: " + data[k].avg_delay_time_2019 + " minutes </p>"+ 
    "</h3><hr><p>2018 Number of Delay Happened: " + data[k].num_delays_2018 +
    " </p><hr><p> 2018 Avg Delay Time: " + data[k].avg_delay_time_2018 + " minutes </p>").addTo(line4layer);
